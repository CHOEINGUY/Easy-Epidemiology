export default {
  ...
  guide: {
    ...
    sections: {
      ...
      pvalue: {
        title: 'P-value',
        description: 'The probability that the calculated Relative Risk (RR) was observed by chance. Typically, a value less than {val} is considered statistically significant.',
        method: {
