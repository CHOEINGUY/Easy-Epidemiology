export default {
  ...
  features: {
    ...
    f1: {
      title: "데이터 입력 & 검증",
      desc: "Web Worker 기반 비동기 처리와 가상 스크롤 기술로 대용량 데이터를 지연 없이 입력하며 실시간 유효성 검증 수행",
    },
    f2: {
      title: "대상자 특성 분석",
      desc: "변수별 빈도분포와 발병률(AR) 자동 계산, 라벨 매핑 시스템을 통한 직관적인 범주 처리 및 동적 시각화",
    },
    f3: {
      title: "임상증상 분석",
      desc: "ECharts 기반의 고성능 인터랙티브 차트, 다중 정렬 알고리즘과 실시간 필터링을 통한 증상 패턴 정밀 분석",
    },
    f4: {
      title: "유행곡선 & 잠복기",
      desc: "잠복기 통계량(최소/최대/평균/중앙값) 자동 산출 및 노출일자 추정을 위한 역학적 곡선 시각화",
    },
    f5: {
      title: "환자대조군 연구",
      desc: "Fisher 정확검정(기대빈도<5), Yates 연속성 보정 자동 적용 및 Log-scale 변환을 통한 OR 95% 신뢰구간 정밀 산출",
    },
    f6: {
      title: "코호트 연구",
      desc: "상대위험도(RR) 및 발병률(Incidence Rate) 산출, 0셀 발생 시 Haldane 보정(0.5)을 적용한 로버스트한 통계 분석",
    },
  },
  system: {
    title: "시스템 특징",
  ...
  quickGuide: {
    ...
    steps: {
      s1: {
        title: "데이터 입력",
        desc: "조사대상자 기본정보 및 임상증상 데이터 입력",
      },
      s2: { title: "특성 분석", desc: "대상자 특성별 분포 분석 및 시각화" },
      s3: {
        title: "패턴 분석",
        desc: "유행곡선 생성 및 시간대별 발병 패턴 파악",
      },
