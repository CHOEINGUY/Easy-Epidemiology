        ...
        series: [
          {
            ...
            // @ts-ignore: orientation property might not be strictly typed in some echarts versions but valid for this context or needs 'bar' series customization
            // Actually 'orientation' is not standard series option but ECharts often allows custom props. 
            // However, bar series detects orientation from xAxis/yAxis types. 
            // The original code used it so I will keep it but it might not be necessary.
          }
        ]
      };
    } catch (error) {
