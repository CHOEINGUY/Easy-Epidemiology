...
if (process.env.NODE_ENV === 'development') {
  ...
  console.log('🔧 마이그레이션 도구가 로드되었습니다:');
  console.log('  - checkMigration(): 마이그레이션 상태 확인');
  console.log('  - executeMigration(): 마이그레이션 실행');
  console.log('  - getMigrationStatus(): 마이그레이션 상태 반환');
}
